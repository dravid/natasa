	...
	<div class="row">
		<div class="box">
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 text-center saradnici">
				<img class="img-responsive" src="img/saradnici/istvan.jpg" alt="">
				<h3>Istvan Czekus<br>
					<small>Photography and fashion advisor</small>
				</h3>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 text-center saradnici">
				...
				<h3>Goca Miladinović<br>
					<small>hair, makeup and fashion advisor</small>
				</h3>
...
<!-- Modal -->
<div class="modal fade" id="istvan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Istvan Czekus</h4>
      </div>
      <div class="modal-body">
        <img class="img-responsive img-centered" src="img/saradnici/istvan.jpg" alt="Istvan Czekus">
...
<div class="modal fade" id="goca" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Goca Miladinović</h4>
      </div>
      <div class="modal-body">
        <img class="img-responsive img-centered" src="img/saradnici/goca.jpg" alt="Goca Miladinović">
		<p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna 
		aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
		Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
		Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
...
<div class="modal fade" id="radivoj" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Radivoj Paroški</h4>
      </div>
      <div class="modal-body">
        <img class="img-responsive img-centered" src="img/saradnici/radivoj.jpg" alt="Radivoj Paroški">
		<p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna 
		aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
		Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
		Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
...
<div class="modal fade" id="emese" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Emese Backai</h4>
      </div>
      <div class="modal-body">
        <img class="img-responsive img-centered" src="img/saradnici/emese.jpg" alt="Emese Backai">
		<p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna 
		aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
		Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
		Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
